...
const hi: TranslationType = {
  ...
  chatView: {
    ...
    unexpectedError: "��� बंद करते समय एक अनपेक्षित त्रुटि हुई",
  ...
  toolsForm: {
    ...
    toolNotFoundMessage: "क्षमा करें, आप जिस उपकरण ���ी तलाश कर रहे हैं वह मौजूद हीं है या हटा दिया गया है।",
  ...
  common: {
    ...
    errorConnection: "त्रुटि: सर्वर से कनेक्शन ���्थापित नहीं किया जा सका",
    apiKey: "एपीआई कुंजी",
    model: "मॉडल",
    select: "चुनें"
  },
  robotCard: {
    ...
    knowledge: "ज्ञान",
    helpTexts: {
      knowledge: "वह ज्ञान और जानकारी प्रबंधित करें जो आपका सहायक उत्तर देने के लिए उपयोग करेगा",
      ...
      test: "वस्तविक समय में अपने सहायक के व्यवहार का परीक्षण करें और वार्तालाप में भाग लें",
