...
const fr: TranslationType = {
  ...
  login: {
    title: "Gents",
    subtitle: "GENTS® système basé sur l'IA générative",
    version: "v 0.1",
    rotatingTexts: [
  ...
  robotCard: {
    ...
    tools: "Outils",
    edit: "Modifier",
    testAgent: "Tester Chat",
    monitorAgent: "Surveiller",
    delete: "Supprimer",
    ...
    helpTexts: {
      ...
      monitor: "Surveillez les conversations actives et les performances de votre assistant en temps réel",
